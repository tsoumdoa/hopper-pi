---
name: gh-conventions
description: Grasshopper build conventions: geometry approach, script policy, C# boilerplate, canvas layout rules, preview pattern, visibility rules, quality bar. Reference this when building, modifying, or validating Grasshopper definitions.
---

# GH Conventions (Shared Reference)

> **All agents must follow these rules.** This is a on-demand reference — load it when you need specifics about Grasshopper build patterns, script structure, or canvas conventions.
...
| Task | Owner | When |
|------|-------|-----|
| Flag visual geometry outputs | computational-designer | Phase 2 — classify outputs as "visual" or "data" |
| Plan Preview Pattern (components + wiring + hide list) | gh-expert | Phase 3 — include in blueprint |
| Create Preview/Swatch, wire them, set hidden:true | canvas-agent | Phase 4 — execute as part of build |
| Verify Preview Pattern is present and correct | validator | Phase 6 — compliance check |
