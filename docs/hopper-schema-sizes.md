...
|-------|-----------:|-------:|
| `default` | 5,791 | 12,000 |
| `canvas_edits` | 10,276 | 18,000 |
| `script_edits` | 11,698 | 22,000 |
| `rhino_document` | 9,207 | 18,000 |
| `rhino_references` | 6,790 | 18,000 |
| `mixed_canvas_script` | 16,183 | 18,000 |
| `mixed_canvas_rhino` | 14,691 | 18,000 |
| `mixed_script_rhino` | 16,113 | 18,000 |
| `capture_default` | 6,676 | 12,000 |
| `capture_mixed_canvas_script` | 17,068 | 18,000 |
| `capture_mixed_script_rhino` | 16,998 | 18,000 |
