...
Users open Rhino and run `HopperCode`. Multiple manually connected processes share the host. `HopperBootstrap`, process launch tickets, launch tools, and their recovery UI are removed; agent-managed process launching is deferred.
