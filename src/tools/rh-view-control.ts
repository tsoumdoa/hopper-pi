...
export const rhViewControlTool = defineTool({
	...
	description:
		"Change the active Rhino viewport or camera: activate a view, restore standard/named/CPlane views, set camera properties, zoom, or save a named view. " +
		"Prefer over rh_run_script for normal view changes. Use saveNamedView only when the user asked to create/update a named view. " +
		"One-off screenshots: rh_capture_view.view can switch temporarily and restore.",
